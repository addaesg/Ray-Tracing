...
namespace shapes
{   
    struct rayTracingConst
    {
        double r;
        double t;
        double n;
        rayTracingConst();
        rayTracingConst(double kr, double kt, double n);
    };
    /* 
    ...
    */
    struct phongConst
    {
        ...
        //n  = expoente de phong
        double n;
        //rt = (Temp) ray tracing constants things
        shapes::rayTracingConst rt;
        phongConst();
        phongConst(double ka, double kd, double ks, double n, shapes::rayTracingConst rt);
    };
